...
location1 = Location.create(name: "Тренажёрный зал на Бангалор", zip_code: "220023", company_id: parent.id)
...
location2 = Location.create(name: "Спортивный комплекс 'Империя'", zip_code: "345557", company_id: parent.id)
Stream.create(title: 'Подвальная камера 1', link: 'https://www.youtube.com/watch?v=oD9mqMYt6Eg', location_id: location2.id)
Location.create(name: "Тренажёрный зал в подвальном помещении \#1", zip_code: "345422", company_id: parent.id)
Location.create(name: "Тренажёрный зал в подвальном помещении \#2", zip_code: "330032", company_id: parent.id)
Location.create(name: "Тренажёрный зал №3", zip_code: "430027", company_id: parent.id)
...
Location.create(name: "Комплекс спортивных бассейнов \"Поссейдон\"", zip_code: "220017", company_id: parent.id)
...
Location.create(name: "Бассейн на Веры Хоружей", zip_code: "230427", company_id: parent.id)
Location.create(name: "Бассейн в дет. саду №356", zip_code: "144437", company_id: parent.id)

parent.categories << sw
parent.merchants << m2

parent = Company.create(title: "ХариКришна", description: "Найди в себе умиротворение!")
Location.create(name: "Йога хакатон 'Imaguru'", zip_code: "220007", company_id: parent.id)
Location.create(name: "Опен-эйр йога площадка", zip_code: "100937", company: parent)
Location.create(name: "Матсерклассы по Йоге от гуру Хатико", zip_code: "000027", company: parent)
Location.create(name: "Йога на пр. Победителей", zip_code: "120007", company: parent)
...
location1 = Location.create(name: "CHALLENGER-19 (турнир для игроков начинающего и среднего уровня)", zip_code: "220025", company_id: parent.id)
